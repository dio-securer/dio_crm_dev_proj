...
@Module({
  ...
  controllers: [AuthController, PlatformController, CommonCodeController],
  providers: [DatabaseService, AuthService, PlatformService, AuthGuard, PermissionGuard, InterfaceService]
})
